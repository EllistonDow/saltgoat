...
### Changes
- 修改 19 个文件: README.md, docs/monitoring-playbook.md, modules/lib/backup_notify.py, modules/lib/notification.py, modules/lib/notification_queue.py 等
...
- 安装流程自动部署 Restic 最新稳定版与 Percona XtraBackup 8.4，默认启用 `optional.backup-restic` 与 `optional.mysql-backup`，备份工具开箱即用。
...
### Changes
- 修改 2 个文件: modules/pwa/overrides/packages/venia-ui/lib/components/CheckoutPage/PaymentInformation/paymentMethods.module.css, modules/pwa/overrides/packages/venia-ui/lib/components/CheckoutPage/checkoutPage.js
...
### Changes
- 修改 1 个文件: docs/pwa-home-sync.md
...
### Changes
- 修改 3 个文件: modules/pwa/overrides/packages/venia-ui/lib/components/AccountMenu/accountMenu.js, modules/pwa/overrides/packages/venia-ui/lib/components/MegaMenu/submenu.js, modules/pwa/overrides/packages/venia-ui/lib/components/MiniCart/miniCart.js
...
### Changes
- 修改 8 个文件: modules/pwa/overrides/packages/venia-ui/lib/components/AccountMenu/accountMenu.module.css, modules/pwa/overrides/packages/venia-ui/lib/components/CheckoutPage/PaymentInformation/paymentMethods.js, modules/pwa/overrides/packages/venia-ui/lib/components/CheckoutPage/PaymentInformation/paymentMethods.module.css, modules/pwa/overrides/packages/venia-ui/lib/components/CheckoutPage/ShippingInformation/shippingInformation.module.css, modules/pwa/overrides/packages/venia-ui/lib/components/MiniCart/miniCart.module.css 等


## [1.6.27] - 2025-11-13

### Changes
- 修改 1 个文件: modules/pwa/overrides/packages/venia-ui/lib/components/CheckoutPage/ShippingInformation/shippingInformation.module.css
...
### Changes
- 修改 1 个文件: docs/pwa-project-guide.md
...
### Changes
- 修改 1 个文件: modules/pwa/templates/cms/pwa_home.html
...
### Changes
- 修改 1 个文件: modules/pwa/overrides/packages/venia-ui/lib/components/Header/header.module.css


## [1.6.17] - 2025-11-12

### Changes
- 修改 1 个文件: modules/pwa/overrides/packages/venia-ui/lib/components/FilterModal/FilterList/filterList.module.css
...
### Changes
- 修改 3 个文件: modules/pwa/overrides/packages/venia-ui/lib/components/ProductFullDetail/productFullDetail.module.css, modules/pwa/overrides/packages/venia-ui/lib/components/ProductOptions/swatch.module.css, modules/pwa/overrides/packages/venia-ui/lib/components/ProductOptions/tile.module.css
...
### Changes
- 修改 1 个文件: modules/pwa/overrides/packages/venia-ui/lib/components/ProductFullDetail/productFullDetail.module.css
...
### Changes
- 修改 1 个文件: modules/pwa/overrides/packages/venia-ui/lib/components/MegaMenu/submenu.module.css
...
### Changes
- 修改 10 个文件: docs/pwa-project-guide.md, modules/pwa/install.sh, modules/pwa/templates/cms/pwa_home.html, modules/pwa/workspaces/saltgoat-venia-extension/src/components/HomeContent/Showcase.js, modules/pwa/workspaces/saltgoat-venia-extension/src/components/HomeContent/index.js 等
...
### Changes
- 修改 6 个文件: modules/pwa/overrides/packages/venia-concept/local-intercept.js, modules/pwa/overrides/packages/venia-ui/lib/components/MegaMenu/submenu.module.css, modules/pwa/overrides/packages/venia-ui/lib/components/Navigation/navigation.module.css, modules/pwa/workspaces/saltgoat-venia-extension/src/components/ThemeProvider/index.js, modules/pwa/workspaces/saltgoat-venia-extension/src/styles/theme.global.module.css 等
...
### Changes
- 修改 3 个文件: modules/pwa/workspaces/saltgoat-venia-extension/src/components/ThemeProvider/index.js, modules/pwa/workspaces/saltgoat-venia-extension/src/styles/theme.global.module.css, modules/pwa/workspaces/saltgoat-venia-extension/src/styles/theme.module.css
...
### Changes
- 修改 1 个文件: modules/lib/notification.py
...
### Changes
- 修改 10 个文件: modules/magetools/__pycache__/magento_api_watch.cpython-312.pyc, modules/magetools/__pycache__/magento_summary.cpython-312.pyc, modules/magetools/backup-restic.sh, modules/magetools/magento_api_watch.py, modules/magetools/magento_summary.py 等
...
### Changes
- 修改 10 个文件: core/install.sh, lib/help.sh, modules/magetools/magento-schedule.py, modules/monitoring/resource_alert.py, monitoring/README.md 等


## [1.3.1] - 2025-11-02

### Changes
- 修改 4 个文件: core/install.sh, modules/magetools/magento-schedule.py, modules/monitoring/resource_alert.py, monitoring/README.md
